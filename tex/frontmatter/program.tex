...
\section*{1. Motivación \hfill (1 h)}
...
\section*{2. Estructura atómica: terminología \hfill (1 h)}
...
\section*{3. Radioactividad y radiación \hfill (1:30 h)}
...
\section*{4. Interacción de la radiación con la materia \hfill (1 h)}
...
\textbf{Práctica no. 1.} \emph{Absorción de las radiaciones beta y gamma.} \hfill (1 h)

\section*{5. Exposición y dosis. Unidades \hfill (1 h)}
...
\section*{6. Efectos biológicos de la radiación \hfill (2:30 h)}
...
\section*{7. Medición de la radiación \hfill (0:30 h)}
...
\textbf{a) Dosímetros de bolsillo \hfill (0:30 h)}
...
\textbf{Práctica no. 2.} \emph{Manejo y uso del dosímetro de bolsillo de lectura directa} \hfill (1:00 h)

\textbf{b) Dosímetros de película y termoluminiscentes \hfill (0:30 h)}
...
\textbf{c) Detector con alarma sonora \hfill (0:30 h)}
...
\textbf{Práctica no. 3.} \emph{Manejo y uso del detector con alarma sonora} \hfill (1 h)
...
\textbf{a) Monitor con detector Geiger \hfill (1 h)}
...
\textbf{Práctica no. 4.} \emph{Manejo y uso de un monitor con detector Geiger} \hfill (1 h)

\textbf{Práctica no. 5.} \emph{Localización de fuentes con Geiger--Müller} \hfill (1:30 h)

\section*{8. Filosofía de la protección radiológica \hfill (2 h)}
...
\subsection*{9.1. Distancia y tiempo como medios de protección \hfill (2 h)}
...
\textbf{Práctica no. 6.} \emph{Aplicación de la ley del cuadrado inverso} \hfill (1:30 h)

\subsection*{9.2. El blindaje como medio de protección \hfill (1 h)}
...
\textbf{Práctica no. 7.} \emph{Atenuación de la radiación gamma, determinación de la capa hemirreductora utilizando diversos materiales (plomo, concreto, ladrillo, agua)} \hfill (1 h)

\subsection*{9.3. Protección contra la contaminación externa y la ingestión o la inhalación \hfill (0:30 h)}
...
\subsection*{9.4. La protección radiológica durante el trabajo \hfill (1 h)}
...
\subsection*{10.1. Principios de la utilización de la fuente y descripción de los equipos asociados en el uso \hfill (1 h)}

\subsection*{10.2. Procedimientos generales para el transporte y almacenamiento de material radiactivo \hfill (1 h)}
...
\section*{11. Normas y reglamentos \hfill (1:30 h)}
...
\section*{12. Análisis de incidentes y accidentes (casos reales) \hfill (3 h)}
...
\textbf{Práctica no. 8.} \emph{Manejo de un equipo radiográfico, solución de fallas} \hfill (2 h)

\textbf{Práctica no. 9.} \emph{Recuperación de fuentes, uso de manipuladores a distancia} \hfill (2 h)

\textbf{Práctica no. 10.} \emph{Simulacro de un accidente} \hfill (4 h)

\textbf{Evaluación final teórico-práctica.}

Duración total del curso: 40 h (24 h teoría, 16 h práctica).
